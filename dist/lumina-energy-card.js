...
class LuminaEnergyCardEditor extends HTMLElement {
  ...
  _buildStrings() {
    return {
      ...
      pl: {
        sections: {
          general: { title: 'Ustawienia ogólne', helper: 'Metadane karty, tło, język i częstotliwość aktualizacji.' },
          array1: { title: 'Instalacja 1', helper: 'Wybierz encje PV, baterii, sieci, obciążenia i EV używane przez kartę. Wymagane jest podanie przynajmniej sensora całkowitej produkcji PV lub poszczególnych łańcuchów (stringów).' },
          array2: { title: 'Instalacja 2', helper: 'Jeśli ustawisz Sensor Całkowity PV (Falownik 2) lub podasz wartości łańcuchów PV, Instalacja 2 stanie się aktywna. Musisz również włączyć Sensor Produkcji Dziennej (Instalacja 2) oraz Obciążenie Domu (Falownik 2).' },
          battery: { title: 'Bateria', helper: 'Konfiguracja encji baterii (magazynu energii).' },
          grid: { title: 'Sieć', helper: 'Konfiguracja encji sieci energetycznej.' },
          car: { title: 'Samochód', helper: 'Konfiguracja encji pojazdu elektrycznego (EV).' },
          other: { title: 'Inne', helper: 'Dodatkowe sensory i zaawansowane przełączniki.' },
          pvPopup: { title: 'Popup PV', helper: 'Konfiguracja encji dla okienka szczegółów PV.' },
          housePopup: { title: 'Popup Domu', helper: 'Konfiguracja encji dla okienka szczegółów domu.' },
          batteryPopup: { title: 'Popup Baterii', helper: 'Konfiguracja encji dla okienka szczegółów baterii.' },
          colors: { title: 'Kolory i progi', helper: 'Konfiguracja progów sieci i kolorów akcentujących dla przepływów oraz wyświetlania EV.' },
          typography: { title: 'Typografia', helper: 'Dostosuj rozmiary czcionek używanych na karcie.' },
          about: { title: 'O karcie', helper: 'Autorzy, wersja i przydatne linki.' }
        },
        fields: {
          card_title: { label: 'Tytuł karty', helper: 'Tytuł wyświetlany na górze karty. Zostaw puste, aby wyłączyć.' },
          background_image: { label: 'Ścieżka obrazu tła', helper: 'Ścieżka do obrazu tła (np. /local/community/lumina-energy-card/lumina_background.png).' },
          background_image_heat_pump: { label: 'Ścieżka obrazu tła (Pompa ciepła)', helper: 'Ścieżka do obrazu tła pompy ciepła (np. /local/community/lumina-energy-card/lumina-energy-card-hp.png).' },
          language: { label: 'Język', helper: 'Wybierz język edytora.' },
          display_unit: { label: 'Jednostka wyświetlania', helper: 'Jednostka używana przy formatowaniu wartości mocy.' },
          update_interval: { label: 'Interwał aktualizacji', helper: 'Częstotliwość odświeżania karty (0 wyłącza ograniczenia).' },
          animation_speed_factor: { label: 'Współczynnik prędkości animacji', helper: 'Dostosuj mnożnik prędkości (-3x do 3x). Ustaw 0 by zatrzymać; wartości ujemne odwracają kierunek.' },
          animation_style: { label: 'Styl animacji', helper: 'Wybierz motyw animacji przepływu (kreski, kropki lub strzałki).' },

          sensor_pv_total: { label: 'Sensor całkowity PV', helper: 'Opcjonalny sensor łącznej produkcji wyświetlany jako główna linia.' },
          sensor_pv_total_secondary: { label: 'Sensor całkowity PV (Falownik 2)', helper: 'Opcjonalna suma drugiego falownika; dodawana do całkowitego PV, jeśli podana.' },
          sensor_pv1: { label: 'Łańcuch PV 1 (Instalacja 1)', helper: 'Główny sensor produkcji solarnej.' },
          sensor_pv2: { label: 'Łańcuch PV 2 (Instalacja 1)' },
          sensor_pv3: { label: 'Łańcuch PV 3 (Instalacja 1)' },
          sensor_pv4: { label: 'Łańcuch PV 4 (Instalacja 1)' },
          sensor_pv5: { label: 'Łańcuch PV 5 (Instalacja 1)' },
          sensor_pv6: { label: 'Łańcuch PV 6 (Instalacja 1)' },
          solar_array2_title: { label: 'Instalacja 2 (Opcjonalna)' },
          sensor_pv_array2_1: { label: 'Łańcuch PV 1 (Instalacja 2)', helper: 'Sensor produkcji solarnej Instalacji 2.' },
          sensor_pv_array2_2: { label: 'Łańcuch PV 2 (Instalacja 2)', helper: 'Sensor produkcji solarnej Instalacji 2.' },
          sensor_pv_array2_3: { label: 'Łańcuch PV 3 (Instalacja 2)', helper: 'Sensor produkcji solarnej Instalacji 2.' },
          sensor_pv_array2_4: { label: 'Łańcuch PV 4 (Instalacja 2)', helper: 'Sensor produkcji solarnej Instalacji 2.' },
          sensor_pv_array2_5: { label: 'Łańcuch PV 5 (Instalacja 2)', helper: 'Sensor produkcji solarnej Instalacji 2.' },
          sensor_pv_array2_6: { label: 'Łańcuch PV 6 (Instalacja 2)', helper: 'Sensor produkcji solarnej Instalacji 2.' },
          show_pv_strings: { label: 'Pokaż poszczególne łańcuchy PV', helper: 'Włącz, aby wyświetlić sumę oraz każdy łańcuch PV w oddzielnych liniach.' },
          sensor_daily: { label: 'Sensor produkcji dziennej (Wymagany)', helper: 'Sensor raportujący dzienne sumy produkcji. Musisz podać przynajmniej sensor całkowity lub łańcuchy PV.' },
          sensor_daily_array2: { label: 'Sensor produkcji dziennej (Instalacja 2)', helper: 'Sensor raportujący dzienne sumy produkcji dla Instalacji 2.' },
          sensor_bat1_soc: { label: 'Bateria 1 SOC (Naładowanie)' },
          sensor_bat1_power: { label: 'Moc Baterii 1' },
          sensor_bat2_soc: { label: 'Bateria 2 SOC' },
          sensor_bat2_power: { label: 'Moc Baterii 2' },
          sensor_bat3_soc: { label: 'Bateria 3 SOC' },
          sensor_bat3_power: { label: 'Moc Baterii 3' },
          sensor_bat4_soc: { label: 'Bateria 4 SOC' },
          sensor_bat4_power: { label: 'Moc Baterii 4' },
          sensor_home_load: { label: 'Obciążenie/Zużycie domu (Wymagane)', helper: 'Sensor całkowitego zużycia energii w domu.' },
          sensor_home_load_secondary: { label: 'Obciążenie domu (Falownik 2)', helper: 'Opcjonalny sensor obciążenia domu dla drugiego falownika.' },
          sensor_heat_pump_consumption: { label: 'Zużycie pompy ciepła', helper: 'Sensor zużycia energii przez pompę ciepła.' },
          sensor_grid_power: { label: 'Moc sieci', helper: 'Sensor przepływu sieci (dodatni/ujemny). Podaj ten sensor ALBO oba sensory importu i eksportu.' },
          sensor_grid_import: { label: 'Sensor importu z sieci', helper: 'Opcjonalna encja raportująca moc pobieraną (dodatnią).' },
          sensor_grid_export: { label: 'Sensor eksportu do sieci', helper: 'Opcjonalna encja raportująca moc oddawaną (dodatnią).' },
          sensor_grid_import_daily: { label: 'Dzienny import z sieci', helper: 'Opcjonalna encja raportująca skumulowany import dla bieżącego dnia.' },
          sensor_grid_export_daily: { label: 'Dzienny eksport do sieci', helper: 'Opcjonalna encja raportująca skumulowany eksport dla bieżącego dnia.' },
          show_daily_grid: { label: 'Pokaż dzienne wartości sieci', helper: 'Pokaż dzienne sumy importu/eksportu pod aktualnym przepływem sieci.' },
          show_grid_flow_label: { label: 'Pokaż nazwę Import/Eksport', helper: 'Dodaj etykietę pobieranie/wysyłanie przed wartością sieci.' },
          pv_tot_color: { label: 'Kolor PV Suma', helper: 'Kolor tekstu PV TOTAL.' },
          pv_primary_color: { label: 'Kolor przepływu PV 1', helper: 'Kolor używany dla głównej linii animacji PV.' },
          pv_secondary_color: { label: 'Kolor przepływu PV 2', helper: 'Kolor używany dla drugiej linii animacji PV (jeśli dostępna).' },
          pv_string1_color: { label: 'Kolor łańcucha PV 1', helper: 'Nadpisanie koloru dla S1. Zostaw puste, aby dziedziczyć z PV Suma.' },
          pv_string2_color: { label: 'Kolor łańcucha PV 2', helper: 'Nadpisanie koloru dla S2. Zostaw puste, aby dziedziczyć z PV Suma.' },
          pv_string3_color: { label: 'Kolor łańcucha PV 3', helper: 'Nadpisanie koloru dla S3. Zostaw puste, aby dziedziczyć z PV Suma.' },
          pv_string4_color: { label: 'Kolor łańcucha PV 4', helper: 'Nadpisanie koloru dla S4. Zostaw puste, aby dziedziczyć z PV Suma.' },
          pv_string5_color: { label: 'Kolor łańcucha PV 5', helper: 'Nadpisanie koloru dla S5. Zostaw puste, aby dziedziczyć z PV Suma.' },
          pv_string6_color: { label: 'Kolor łańcucha PV 6', helper: 'Nadpisanie koloru dla S6. Zostaw puste, aby dziedziczyć z PV Suma.' },
          load_flow_color: { label: 'Kolor przepływu obciążenia', helper: 'Kolor linii animacji zużycia domu.' },
          load_text_color: { label: 'Kolor tekstu obciążenia', helper: 'Kolor tekstu zużycia domu, gdy progi są nieaktywne.' },
          house_total_color: { label: 'Kolor sumy domu', helper: 'Kolor stosowany do tekstu/przepływu HOUSE TOT.' },
          ...
          load_threshold_warning: { label: 'Próg ostrzegawczy obciążenia', helper: 'Zmień kolor, gdy wartość równa lub większa. Używa wybranej jednostki.' },
          load_warning_color: { label: 'Kolor ostrzegawczy obciążenia', helper: 'Kolor Hex lub CSS stosowany po przekroczeniu progu ostrzegawczego.' },
          load_threshold_critical: { label: 'Próg krytyczny obciążenia', helper: 'Zmień kolor, gdy wartość równa lub większa. Używa wybranej jednostki.' },
          load_critical_color: { label: 'Kolor krytyczny obciążenia', helper: 'Kolor Hex lub CSS stosowany po przekroczeniu progu krytycznego.' },
          battery_soc_color: { label: 'Kolor SOC baterii', helper: 'Kolor Hex stosowany do tekstu procentowego naładowania baterii.' },
          battery_charge_color: { label: 'Kolor ładowania baterii', helper: 'Kolor używany, gdy energia płynie DO baterii.' },
          battery_discharge_color: { label: 'Kolor rozładowania baterii', helper: 'Kolor używany, gdy energia płynie Z baterii.' },
          grid_import_color: { label: 'Kolor importu z sieci', helper: 'Kolor bazowy (przed progami) przy pobieraniu z sieci.' },
          grid_export_color: { label: 'Kolor eksportu do sieci', helper: 'Kolor bazowy (przed progami) przy wysyłaniu do sieci.' },
          car_flow_color: { label: 'Kolor przepływu EV', helper: 'Kolor linii animacji pojazdu elektrycznego.' },
          battery_fill_high_color: { label: 'Kolor wypełnienia baterii (Normalny)', helper: 'Kolor wypełnienia cieczą, gdy SOC jest powyżej niskiego progu.' },
          battery_fill_low_color: { label: 'Kolor wypełnienia baterii (Niski)', helper: 'Kolor wypełnienia cieczą, gdy SOC jest równy lub poniżej niskiego progu.' },
          battery_fill_low_threshold: { label: 'Próg niskiego poziomu baterii (%)', helper: 'Użyj niskiego koloru wypełnienia, gdy SOC jest równe lub mniejsze niż ten procent.' },
          grid_activity_threshold: { label: 'Próg animacji sieci (W)', helper: 'Ignoruj przepływy sieci poniżej tej wartości (w Watach) przed animowaniem.' },
          grid_threshold_warning: { label: 'Próg ostrzegawczy sieci', helper: 'Zmień kolor sieci, gdy wartość równa lub większa.' },
          grid_warning_color: { label: 'Kolor ostrzegawczy sieci', helper: 'Kolor Hex lub CSS przy progu ostrzegawczym.' },
          grid_threshold_critical: { label: 'Próg krytyczny sieci', helper: 'Zmień kolor sieci, gdy wartość równa lub większa.' },
          grid_critical_color: { label: 'Kolor krytyczny sieci', helper: 'Kolor Hex lub CSS przy progu krytycznym.' },
          invert_grid: { label: 'Odwróć wartości sieci', helper: 'Włącz, jeśli polaryzacja importu/eksportu jest odwrócona.' },
          invert_battery: { label: 'Odwróć wartości baterii', helper: 'Włącz, jeśli polaryzacja ładowania/rozładowania jest odwrócona.' },
          sensor_car_power: { label: 'Sensor mocy Auta 1' },
          sensor_car_soc: { label: 'Sensor SOC Auta 1' },
          car_soc: { label: 'SOC Auta', helper: 'Sensor poziomu naładowania baterii EV.' },
          car_range: { label: 'Zasięg Auta', helper: 'Sensor zasięgu EV.' },
          car_efficiency: { label: 'Wydajność Auta', helper: 'Sensor wydajności EV.' },
          car_charger_power: { label: 'Moc ładowarki Auta', helper: 'Sensor mocy ładowarki EV.' },
          car1_label: { label: 'Etykieta Auta 1', helper: 'Tekst wyświetlany obok wartości pierwszego EV.' },
          sensor_car2_power: { label: 'Sensor mocy Auta 2' },
          car2_power: { label: 'Moc Auta 2', helper: 'Sensor mocy ładowania/rozładowania EV 2.' },
          sensor_car2_soc: { label: 'Sensor SOC Auta 2' },
          car2_soc: { label: 'SOC Auta 2', helper: 'Sensor poziomu naładowania baterii EV 2.' },
          car2_range: { label: 'Zasięg Auta 2', helper: 'Sensor zasięgu EV 2.' },
          car2_efficiency: { label: 'Wydajność Auta 2', helper: 'Sensor wydajności EV 2.' },
          car2_charger_power: { label: 'Moc ładowarki Auta 2', helper: 'Sensor mocy ładowarki EV 2.' },
          car2_label: { label: 'Etykieta Auta 2', helper: 'Tekst wyświetlany obok wartości drugiego EV.' },
          show_car_soc: { label: 'Pokaż Auto 1', helper: 'Włącz, aby wyświetlać dane pierwszego EV.' },
          show_car2: { label: 'Pokaż Auto 2', helper: 'Włącz, aby wyświetlać dane drugiego EV (gdy podano sensory).' },
          car_pct_color: { label: 'Kolor SOC Auta', helper: 'Kolor Hex dla tekstu SOC EV (np. #00FFFF).' },
          car2_pct_color: { label: 'Kolor SOC Auta 2', helper: 'Kolor Hex dla tekstu SOC drugiego EV (domyślnie dziedziczy z Auta 1).' },
          car1_name_color: { label: 'Kolor nazwy Auta 1', helper: 'Kolor stosowany do etykiety nazwy Auta 1.' },
          car2_name_color: { label: 'Kolor nazwy Auta 2', helper: 'Kolor stosowany do etykiety nazwy Auta 2.' },
          car1_color: { label: 'Kolor Auta 1', helper: 'Kolor stosowany do wartości mocy Auta 1.' },
          car2_color: { label: 'Kolor Auta 2', helper: 'Kolor stosowany do wartości mocy Auta 2.' },
          heat_pump_flow_color: { label: 'Kolor przepływu pompy ciepła', helper: 'Kolor stosowany do animacji pompy ciepła.' },
          heat_pump_text_color: { label: 'Kolor tekstu pompy ciepła', helper: 'Kolor stosowany do tekstu mocy pompy ciepła.' },
          ...
          battery_power_font_size: { label: 'Rozmiar czcionki mocy baterii (px)', helper: 'Domyślnie 16' },
          ...
          sensor_popup_pv_1: { label: 'Popup PV 1', helper: 'Encja dla linii 1 w popupie PV.' },
          sensor_popup_pv_2: { label: 'Popup PV 2', helper: 'Encja dla linii 2 w popupie PV.' },
          sensor_popup_pv_3: { label: 'Popup PV 3', helper: 'Encja dla linii 3 w popupie PV.' },
          sensor_popup_pv_4: { label: 'Popup PV 4', helper: 'Encja dla linii 4 w popupie PV.' },
          sensor_popup_pv_5: { label: 'Popup PV 5', helper: 'Encja dla linii 5 w popupie PV.' },
          sensor_popup_pv_6: { label: 'Popup PV 6', helper: 'Encja dla linii 6 w popupie PV.' },
          sensor_popup_pv_1_name: { label: 'Nazwa Popup PV 1', helper: 'Opcjonalna nazwa własna. Zostaw puste by użyć nazwy encji.' },
          sensor_popup_pv_2_name: { label: 'Nazwa Popup PV 2', helper: 'Opcjonalna nazwa własna. Zostaw puste by użyć nazwy encji.' },
          sensor_popup_pv_3_name: { label: 'Nazwa Popup PV 3', helper: 'Opcjonalna nazwa własna. Zostaw puste by użyć nazwy encji.' },
          sensor_popup_pv_4_name: { label: 'Nazwa Popup PV 4', helper: 'Opcjonalna nazwa własna. Zostaw puste by użyć nazwy encji.' },
          sensor_popup_pv_5_name: { label: 'Nazwa Popup PV 5', helper: 'Opcjonalna nazwa własna. Zostaw puste by użyć nazwy encji.' },
          sensor_popup_pv_6_name: { label: 'Nazwa Popup PV 6', helper: 'Opcjonalna nazwa własna. Zostaw puste by użyć nazwy encji.' },
          sensor_popup_pv_1_color: { label: 'Kolor Popup PV 1', helper: 'Kolor tekstu dla linii 1.' },
          sensor_popup_pv_2_color: { label: 'Kolor Popup PV 2', helper: 'Kolor tekstu dla linii 2.' },
          sensor_popup_pv_3_color: { label: 'Kolor Popup PV 3', helper: 'Kolor tekstu dla linii 3.' },
          sensor_popup_pv_4_color: { label: 'Kolor Popup PV 4', helper: 'Kolor tekstu dla linii 4.' },
          sensor_popup_pv_5_color: { label: 'Kolor Popup PV 5', helper: 'Kolor tekstu dla linii 5.' },
          sensor_popup_pv_6_color: { label: 'Kolor Popup PV 6', helper: 'Kolor tekstu dla linii 6.' },
          sensor_popup_pv_1_font_size: { label: 'Rozmiar czcionki Popup PV 1', helper: 'Domyślnie 16' },
          sensor_popup_pv_2_font_size: { label: 'Rozmiar czcionki Popup PV 2', helper: 'Domyślnie 16' },
          sensor_popup_pv_3_font_size: { label: 'Rozmiar czcionki Popup PV 3', helper: 'Domyślnie 16' },
          sensor_popup_pv_4_font_size: { label: 'Rozmiar czcionki Popup PV 4', helper: 'Domyślnie 16' },
          sensor_popup_pv_5_font_size: { label: 'Rozmiar czcionki Popup PV 5', helper: 'Domyślnie 16' },
          sensor_popup_pv_6_font_size: { label: 'Rozmiar czcionki Popup PV 6', helper: 'Domyślnie 16' },

          sensor_popup_house_1: { label: 'Popup Domu 1', helper: 'Encja dla linii 1 w popupie domu.' },
          sensor_popup_house_1_name: { label: 'Nazwa Popup Domu 1', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_house_1_color: { label: 'Kolor Popup Domu 1', helper: 'Kolor tekstu dla linii 1.' },
          sensor_popup_house_1_font_size: { label: 'Rozmiar czcionki Popup Domu 1', helper: 'Domyślnie 16' },
          sensor_popup_house_2: { label: 'Popup Domu 2', helper: 'Encja dla linii 2 w popupie domu.' },
          sensor_popup_house_2_name: { label: 'Nazwa Popup Domu 2', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_house_2_color: { label: 'Kolor Popup Domu 2', helper: 'Kolor tekstu dla linii 2.' },
          sensor_popup_house_2_font_size: { label: 'Rozmiar czcionki Popup Domu 2', helper: 'Domyślnie 16' },
          sensor_popup_house_3: { label: 'Popup Domu 3', helper: 'Encja dla linii 3 w popupie domu.' },
          sensor_popup_house_3_name: { label: 'Nazwa Popup Domu 3', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_house_3_color: { label: 'Kolor Popup Domu 3', helper: 'Kolor tekstu dla linii 3.' },
          sensor_popup_house_3_font_size: { label: 'Rozmiar czcionki Popup Domu 3', helper: 'Domyślnie 16' },
          sensor_popup_house_4: { label: 'Popup Domu 4', helper: 'Encja dla linii 4 w popupie domu.' },
          sensor_popup_house_4_name: { label: 'Nazwa Popup Domu 4', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_house_4_color: { label: 'Kolor Popup Domu 4', helper: 'Kolor tekstu dla linii 4.' },
          sensor_popup_house_4_font_size: { label: 'Rozmiar czcionki Popup Domu 4', helper: 'Domyślnie 16' },
          sensor_popup_house_5: { label: 'Popup Domu 5', helper: 'Encja dla linii 5 w popupie domu.' },
          sensor_popup_house_5_name: { label: 'Nazwa Popup Domu 5', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_house_5_color: { label: 'Kolor Popup Domu 5', helper: 'Kolor tekstu dla linii 5.' },
          sensor_popup_house_5_font_size: { label: 'Rozmiar czcionki Popup Domu 5', helper: 'Domyślnie 16' },
          sensor_popup_house_6: { label: 'Popup Domu 6', helper: 'Encja dla linii 6 w popupie domu.' },
          sensor_popup_house_6_name: { label: 'Nazwa Popup Domu 6', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_house_6_color: { label: 'Kolor Popup Domu 6', helper: 'Kolor tekstu dla linii 6.' },
          sensor_popup_house_6_font_size: { label: 'Rozmiar czcionki Popup Domu 6', helper: 'Domyślnie 16' },

          sensor_popup_bat_1: { label: 'Popup Baterii 1', helper: 'Encja dla linii 1 w popupie baterii.' },
          sensor_popup_bat_1_name: { label: 'Nazwa Popup Baterii 1', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_bat_1_color: { label: 'Kolor Popup Baterii 1', helper: 'Kolor tekstu dla linii 1.' },
          sensor_popup_bat_1_font_size: { label: 'Rozmiar czcionki Popup Baterii 1', helper: 'Domyślnie 16' },
          sensor_popup_bat_2: { label: 'Popup Baterii 2', helper: 'Encja dla linii 2 w popupie baterii.' },
          sensor_popup_bat_2_name: { label: 'Nazwa Popup Baterii 2', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_bat_2_color: { label: 'Kolor Popup Baterii 2', helper: 'Kolor tekstu dla linii 2.' },
          sensor_popup_bat_2_font_size: { label: 'Rozmiar czcionki Popup Baterii 2', helper: 'Domyślnie 16' },
          sensor_popup_bat_3: { label: 'Popup Baterii 3', helper: 'Encja dla linii 3 w popupie baterii.' },
          sensor_popup_bat_3_name: { label: 'Nazwa Popup Baterii 3', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_bat_3_color: { label: 'Kolor Popup Baterii 3', helper: 'Kolor tekstu dla linii 3.' },
          sensor_popup_bat_3_font_size: { label: 'Rozmiar czcionki Popup Baterii 3', helper: 'Domyślnie 16' },
          sensor_popup_bat_4: { label: 'Popup Baterii 4', helper: 'Encja dla linii 4 w popupie baterii.' },
          sensor_popup_bat_4_name: { label: 'Nazwa Popup Baterii 4', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_bat_4_color: { label: 'Kolor Popup Baterii 4', helper: 'Kolor tekstu dla linii 4.' },
          sensor_popup_bat_4_font_size: { label: 'Rozmiar czcionki Popup Baterii 4', helper: 'Domyślnie 16' },
          sensor_popup_bat_5: { label: 'Popup Baterii 5', helper: 'Encja dla linii 5 w popupie baterii.' },
          sensor_popup_bat_5_name: { label: 'Nazwa Popup Baterii 5', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_bat_5_color: { label: 'Kolor Popup Baterii 5', helper: 'Kolor tekstu dla linii 5.' },
          sensor_popup_bat_5_font_size: { label: 'Rozmiar czcionki Popup Baterii 5', helper: 'Domyślnie 16' },
          sensor_popup_bat_6: { label: 'Popup Baterii 6', helper: 'Encja dla linii 6 w popupie baterii.' },
          sensor_popup_bat_6_name: { label: 'Nazwa Popup Baterii 6', helper: 'Opcjonalna nazwa własna.' },
          sensor_popup_bat_6_color: { label: 'Kolor Popup Baterii 6', helper: 'Kolor tekstu dla linii 6.' },
          sensor_popup_bat_6_font_size: { label: 'Rozmiar czcionki Popup Baterii 6', helper: 'Domyślnie 16' }
        },
        options: {
          languages: [
            { value: 'en', label: 'English' },            
